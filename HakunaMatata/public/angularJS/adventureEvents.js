var adventureEvents = angular.module('adventureEvents',[]);

adventureEvents.controller('adventureEvents', function($scope, $filter, $http) {
    ...
    $http({
        method : "POST",
        url : '/getAdventureEvents',//change the method to get 10 items at a time.
        data : {}
    }).success(function(data) {
        console.log("inside success");
        console.log("data is ::");
    ...
    $scope.AddToCart = function(EventId) {
        ...
        $http({
            ...
            if(data.userId=="notFound"){
                ...
                window.location.assign("/adventureEvents");
            }
