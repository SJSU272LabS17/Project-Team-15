var freakEvents = angular.module('freakEvents',[]);

freakEvents.controller('freakEvents', function($scope, $filter, $http) {
    ...
    $http({
        method : "POST",
        url : '/getFreakEvents',//change the method to get 10 items at a time.
        data : {}
    }).success(function(data) {
        console.log("inside success");
        console.log("data is ::");
    ...
    $scope.AddToCart = function(EventId) {
        ...
        $http({
            ...
            if(data.userId=="notFound"){
                ...
                window.location.assign("/freakEvents");
            }
