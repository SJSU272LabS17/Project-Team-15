...
var eventCreationLogin = angular.module('eventCreationLogin', []);
//defining the login controller
eventCreationLogin.controller('eventCreationLogin', function($scope, $window ,$http) {
	...
	$scope.submit = function() {
		...
		$http({
			...
			if (data.statusCode == 401) {
				...
				window.location.assign("/createEventHM");
